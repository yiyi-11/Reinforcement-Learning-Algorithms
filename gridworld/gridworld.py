        ...
        if self.viewer is None:
            ...
            for x in range(self.n_width):
                for y in range(self.n_height):
                    ...
                    if r < 0:
                        rect.set_color(0.7 - r, 0.7 - r, 0.9 + r)
                    elif r > 0:
...
def SimpleGridWorld_WithWall():
    ...
    env.rewards = [(7, 3, 1), (7, 0, -10)]
    # (7, 0, -100) -30时sarsa绕远路，-10时sarsa不绕路

    env.types = [(5, 1, 1), (6, 4, 1), (6, 3, 1), (6, 2, 1)]
